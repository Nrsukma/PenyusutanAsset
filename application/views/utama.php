  ...
  <div class="container py-5">
    <div class="row">
      <div class="col-md-6 mx-auto">
        <h4>Form Perhitungan Penyusutan Asset</h4>
        <form action="<?= base_url('utama/hitung'); ?>" method="POST">
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Umur Ekonomis</label>
